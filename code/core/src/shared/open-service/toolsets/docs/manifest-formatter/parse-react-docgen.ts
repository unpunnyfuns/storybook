...
type TsType = {
  ...
  elements?: TsType[];
  signature?: {
    arguments?: Array<{ name: string; type?: TsType }>;
    return?: TsType;
    properties?: Array<{ key: unknown; value?: TsType & { required?: boolean } }>;
  };
};
...
type PropDescriptor = NonNullable<Documentation['props']>[string];
